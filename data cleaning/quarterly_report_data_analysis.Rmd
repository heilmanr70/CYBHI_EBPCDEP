---
title: "Discharge_QuarterlyReport"
...
This notebook cleans up discharge data and provides counts, percentage with positive outcomes and average scores at pre/post for each assessment tool.
...
discharge_data <- readxl::read_xlsx("C:/Users/heilm/Dropbox/CYBHI Project/Rebecca and Tristan and Cristin/EInsight Data/Exports - Raw/July13_Report_Data/Dishcharge_Report.xlsx", na = c("-", "", "NA"))
demographic_data_updated <- readxl::read_xlsx("C:/Users/heilm/Dropbox/CYBHI Project/Rebecca and Tristan and Cristin/EInsight Data/Exports - Raw/July13_Report_Data/Client_Demographics.xlsx", na = c("-", "", "NA"))
...
write_csv(duplicate_list, "C:/Users/heilm/Dropbox/CYBHI Project/Rebecca and Tristan and Cristin/EInsight Data/duplicate_list_July13.csv")
...
length(unique(dup_clients$client_id)) #171 clients with more than one complete intervention 
...
this should be the inverse of dup_clients_same_time (n=34 + n=55 = n=171)
```{r}
...
write_csv(all_data, "C:/Users/heilm/Dropbox/CYBHI Project/Rebecca and Tristan and Cristin/EInsight Data/demographic_discharge_clean_July13.csv")
...
write_csv(demographic_data_filtered_updated, "C:/Users/heilm/Dropbox/CYBHI Project/Rebecca and Tristan and Cristin/EInsight Data/demographic_data_clean_July13.csv")
...
write_csv(discharge_data_filtered, "C:/Users/heilm/Dropbox/CYBHI Project/Rebecca and Tristan and Cristin/EInsight Data/discharge_data_clean_July13.csv")
```
