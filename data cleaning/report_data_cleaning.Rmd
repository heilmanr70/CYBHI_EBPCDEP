...
discharge_data <- readxl::read_xlsx("/Users/cristin/Dropbox/Data/eInsight Exports/Discharge Report Export/2025-09-17-discharge_report.xlsx", na = c("-", "", "NA", "N/A")) %>% 
  janitor::clean_names()
...
length(unique(dup_clients$client_id)) #310 clients with more than one complete intervention 
```
...
this should be the inverse of dup_clients_same_time (n=158 + n=157 != n=310 --> why??)
```{r}
