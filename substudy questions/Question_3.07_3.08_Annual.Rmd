---
title: "Annual Report Data Analysis - Question 3.07 and 3.08"
...
## 3.07 To what extent did parents/caregivers report improved well-being for themselves and their child after receiving the intervention?

Range: 7–35; Sum = Q3a+...+Q3g.
...
#| warning: false
#| message: false
pairs_primary_long_q3 <- pairs_primary_long_child |>
...
ggplot(q3_child_score_long, aes(x = score_value, fill = score_type)) +
  geom_bar(
  ...
  labs(
    x     = "Measure: Improved Well-Being Score (7-35)",
    y     = "Count",
...
ggplot(q3_child_score_long, aes(x = score_value, y = 1, fill = score_type)) +
  geom_density_ridges(
  ...
  geom_segment(
    data = summary_stats_child_q3,
    aes(x = median_score, y = 1, xend = median_score, yend = 1.08, color = "grey30"),
    linetype = "dotted"
  ) +
  geom_text(
    data = summary_stats_child_q3,
...
The percent of those who had total scores of 28 or higher across Q3 at initial and discharge time points were:
...
## 3.08 To what extent did the youth report improved well-being after receiving the intervention?
...
ggplot(q3_self_score_long, aes(x = score_value, fill = score_type)) +
  geom_bar(
    position = position_dodge2(preserve = "single", padding = 0.01),
    width = 0.8,
    alpha = 0.8
...
ggplot(q3_self_score_long, aes(x = score_value, y = 1, fill = score_type)) +
  geom_density_ridges(
    aes(color = score_type),
    alpha          = 0.7,
    scale          = 1.2,
