...
discharge_data_filtered <- read_csv("/Users/heilm/Dropbox/CYBHI Project/Rebecca and Tristan and Cristin/EInsight Data/discharge_data_clean.csv")
...
openxlsx::write.xlsx(client_serve,"/Users/heilm/Dropbox/CYBHI Project/Rebecca and Tristan and Cristin/Annual Report Development/Results Tables/Client_serve.xlsx")
...
# caregiver
caregiver_raw <- read_csv("/Users/heilm/Dropbox/CYBHI Project/Data/eInsight Exports/Satisfaction Survey Export/Satisfaction_survey-caregiver.csv", na = c("-", "", "NA", "N/A", "0"), col_names = FALSE) 
...
# child
child_raw <- read.csv("/Users/heilm/Dropbox/CYBHI Project/Data/eInsight Exports/Satisfaction Survey Export/Satisfaction_survey-child_13-17.csv", na = c("-", "", "NA", "N/A", "0"), header = FALSE) 
...
# adult
adult_raw <- read.csv("/Users/heilm/Dropbox/CYBHI Project/Data/eInsight Exports/Satisfaction Survey Export/Satisfaction_survey-adult_18-59.csv", na.strings = c("-", "", "NA", "N/A", "0"), skip = 0, header = FALSE)
...
# senior
senior_raw <- read_csv("/Users/heilm/Dropbox/CYBHI Project/Data/eInsight Exports/Satisfaction Survey Export/Satisfaction_survey-adult_60_plus.csv", na = c("-", "", "NA", "N/A", "0"), col_names = FALSE) 
...
openxlsx::write.xlsx(pct_4_5_year,"/Users/heilm/Dropbox/CYBHI Project/Rebecca and Tristan and Cristin/Annual Report Development/Results Tables/Question 1 Satisfaction.xlsx",sheetName="by year")
...
openxlsx::write.xlsx(pct_4_5_overall,"/Users/heilm/Dropbox/CYBHI Project/Rebecca and Tristan and Cristin/Annual Report Development/Results Tables/Question 1 Satisfaction.xlsx",sheetName="overall",append=T)
...
openxlsx::write.xlsx(df2,"/Users/heilm/Dropbox/CYBHI Project/Rebecca and Tristan and Cristin/Annual Report Development/Results Tables/Combined Survey Satisfaction.xlsx",sheetName="df2")
...
openxlsx::write.xlsx(df4,"/Users/heilm/Dropbox/CYBHI Project/Rebecca and Tristan and Cristin/Annual Report Development/Results Tables/Combined Survey Satisfaction.xlsx",sheetName="df4",append=T)
...
openxlsx::write.xlsx(summary_agree_quarter,"/Users/heilm/Dropbox/CYBHI Project/Rebecca and Tristan and Cristin/Annual Report Development/Results Tables/Combined Survey Satisfaction.xlsx",sheetName="quarterly",append=T)
...
openxlsx::write.xlsx(tab4q,"/Users/heilm/Dropbox/CYBHI Project/Rebecca and Tristan and Cristin/Annual Report Development/Results Tables/Client_End.xlsx",sheetName="tab4_quarterly")
...
openxlsx::write.xlsx(tab4y,"/Users/heilm/Dropbox/CYBHI Project/Rebecca and Tristan and Cristin/Annual Report Development/Results Tables/Client_End.xlsx",sheetName="tab4_yearly",append=T)
...
openxlsx::write.xlsx(tab4,"/Users/heilm/Dropbox/CYBHI Project/Rebecca and Tristan and Cristin/Annual Report Development/Results Tables/Client_End.xlsx",sheetName="tab4_overall",append=T)
...
openxlsx::write.xlsx(tab_q,"/Users/heilm/Dropbox/CYBHI Project/Rebecca and Tristan and Cristin/Annual Report Development/Results Tables/Client_Lang.xlsx",sheetName="lang_quarterly")
...
openxlsx::write.xlsx(tab_y,"/Users/heilm/Dropbox/CYBHI Project/Rebecca and Tristan and Cristin/Annual Report Development/Results Tables/Client_Lang.xlsx",sheetName="lang_yearly",append=T)
...
openxlsx::write.xlsx(tab,"/Users/heilm/Dropbox/CYBHI Project/Rebecca and Tristan and Cristin/Annual Report Development/Results Tables/Client_Lang.xlsx",sheetName="lang_overall",append=T)
...
yoq_caregiver_paired %>% 
  ...
  scale_fill_manual("Reliable Change Index",
                    labels = c("no meaningful change (n=93)", "meaningful change (n=114)"), 
...
yoq_self_paired %>% 
  ...
  scale_fill_manual("Reliable Change Index",
                    labels = c("no meaningful change (n=256)", "meaningful change (n=206)"), 
                    values = c("#ABDDDE", "#046C9A"))
```
...
**Count and Percent of Grantees Funded by Round**
...
master_grantee_file <- foreign::read.spss("/Users/cristin/CWS Dropbox/Cristin Young/CYBHI Project/Data/MASTER Grantee Files/Quant Team File/MasterGranteeSpreadsheet_forBHESQuantTeam_11-21-25.sav")
```
