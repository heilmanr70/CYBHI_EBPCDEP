...
openxlsx::write.xlsx(pct_4_5_overall,"/Users/cristin/CWS Dropbox/Cristin Young/CYBHI Project/Rebecca and Tristan and Cristin/Annual Report Development/Results Tables/Question 1 Satisfaction.xlsx",sheetName="overall",append=T)
# xlsx::write.xlsx(pct_4_5_overall,"/Users/cristin/CWS Dropbox/Cristin Young/CYBHI Project/Rebecca and Tristan and Cristin/Annual Report Development/Results Tables/Question 1 Satisfaction.xlsx",sheetName="overall",append=T)
...
pairs_primary_long <- read_csv(file.path(assess_dir, "noms_child_pairs_clean.csv"), show_col_types = FALSE)
```
...
# Produced by data cleaning/noms_data_cleaning.qmd
pairs_primary_long_self <- read_csv(file.path(assess_dir, "noms_self_pairs_clean.csv"), show_col_types = FALSE)
```
...
#clipr::write_clip(summary_stats_self_q4)
