...
combined_q1 <- left_join(combined_q1, all_data_distinct, by = c("provider", "provider_id", "provider_system_id", "client_system_id")) 
combined_q1 <- combined_q1 %>% 
