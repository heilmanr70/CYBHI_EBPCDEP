...
client_serve <- discharge_data_filtered %>% 
  filter(intervention_start >= "2024-01-01") %>% 
    tabyl(intervention_start_quarter)
client_serve 
```
...
# caregiver
caregiver <- read_csv("/Users/cristin/CWS Dropbox/Cristin Young/CYBHI Project/Rebecca and Tristan and Cristin/EInsight Data/satisfaction_caregiver_clean.csv", na = c("-", "", "NA", "N/A", "0")) # col_names = FALSE) 
...
# child
child <- read.csv("/Users/cristin/CWS Dropbox/Cristin Young/CYBHI Project/Rebecca and Tristan and Cristin/EInsight Data/satisfaction_child_clean.csv", na = c("-", "", "NA", "N/A", "0")) # header = FALSE)
...
# adult
adult <- read_csv("/Users/cristin/CWS Dropbox/Cristin Young/CYBHI Project/Rebecca and Tristan and Cristin/EInsight Data/satisfaction_adult_clean.csv", na = c("-", "", "NA", "N/A", "0")) #col_names = FALSE)
...
# senior
senior <- read_csv("/Users/cristin/CWS Dropbox/Cristin Young/CYBHI Project/Rebecca and Tristan and Cristin/EInsight Data/satisfaction_senior_clean.csv", na = c("-", "", "NA", "N/A", "0")) #col_names = FALSE) 
...
all_data_distinct <- discharge_data_filtered |>
...
noms_child_raw <- read_xlsx("/Users/cristin/CWS Dropbox/Cristin Young/CYBHI Project/Data/eInsight Exports/Individual Assessments/Archived/NOMS-child.xlsx", na = c("-", "", "NA", "N/A"), col_names = FALSE) 
...
noms_self <- noms_self %>% 
  ...
  filter(date_completed <= "2025-12-31",     #date of running the code
         date_completed >= "2024-01-01")   #date to filter out random issue dates   
...
pairs_primary_long_self <- paired_outcomes_self %>% 
  filter(is_after3) %>% #filtered for assessments >3 days from initial
...
tab <- yoq_caregiver_paired %>% 
  ...
  tabyl(follow_up_quarter, reliably_better) %>% # true = doing reliably better
  adorn_totals("row") %>% 
  adorn_percentages("row") %>%
  adorn_pct_formatting(digits = 0) %>%
  adorn_ns() 
...
## Client_groups: insurance status
...
## Client_groups: sexual orientation
...
## Client_groups: preferred language
